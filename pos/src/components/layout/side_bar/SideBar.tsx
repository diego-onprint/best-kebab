...
const SideBar = () => {
  ...
  const printSomething = () => {
    ...
    const data = toBase64(testHtml)

    const S = "#Intent;scheme=rawbt;";
    const P = "package=ru.a402d.rawbtprinter;end;";
    const toPrint = `rawbt:data:text/html;base64,${data}`
    window.location.href = "intent:" + toPrint + S + P;

    // {/* <a href="rawbt:url:base64,aHR0cHM6Ly93d3cuYmFzZTY0ZW5jb2RlLm9yZy8=">url 64</a> */ }
    // rawbt:data:text/html;base64,PGEgaHJlZj0iaHR0cHM6Ly9iYXNlNjQub25saW5lIj5CYXNlNjQuT25saW5lPC9hPg==
  }
      ...
      <nav>
        <ul className="flex flex-col gap-4">
          ...
          <li className="grid place-items-center">
            <button onClick={printSomething} className={`flex flex-col items-center p-1 hover:bg-zinc-100 rounded-md ${active === "/orders" && "bg-zinc-100"}`}>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
