...
import { getCurrentWeekDates } from '../../utils/get/getCurrentWeekDates'
import { getLastMonthDates } from '../../utils/get/getLastMonthDates'
import { getLastYearDates } from '../../utils/get/getLastYearDates'
import {
...
const ReportsDashboard = () => {
    ...
    return (
        ...
        <div className={`${dataLoading ? "opacity-50" : ""} col-span-12 flex gap-2`}>
            <CSV currentData={currentData} rawData={rawData} selectedDate={selectedDate} />
        </div>
    </div>
    )
}
