...
import CreateTkwOrder from "../common/create_tkw_order/CreateTkwOrder"
...
type PropsTypes = {
    ...
    ticketDomRef: HTMLElement
    kitchenTicketDomRef: HTMLElement
    getCartTitle: () => string
}
                ...
                <div className="flex flex-col flex-1 h-full pt-1">
                    <div className="flex justify-between shadow-md p-3">
                        ...
                        <div className="flex gap-4 pr-2">
                            {!currentTable ? <CreateTkwOrder /> : null}
                            <PrintButton domRef={ticketDomRef} buttonStyle={`grid place-items-center ${disabled && "opacity-40"}`} disabled={disabled}>
                    ...
                    <dl className="divide-y">
                        <div className={`flex justify-between items-center gap-3 bg-zinc-50 px-4 h-64 ${hasSelectedItemsToPrint ? "max-h-14" : "max-h-0"} transition-all overflow-hidden`}>
                            <textarea rows={1} className="w-full p-2 h-11 border border-zinc-200 resize-none rounded-md" placeholder="Küche Bemerkung" />
                            <div className="w-20">
                                <PrintButton domRef={kitchenTicketDomRef} buttonStyle={`grid place-items-center ${disabled && "opacity-40"}`} disabled={disabled}>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                                        <path strokeLinecap="round" strokeLinejoin="round" d="M6.72 13.829c-.24.03-.48.062-.72.096m.72-.096a42.415 42.415 0 0 1 10.56 0m-10.56 0L6.34 18m10.94-4.171c.24.03.48.062.72.096m-.72-.096L17.66 18m0 0 .229 2.523a1.125 1.125 0 0 1-1.12 1.227H7.231c-.662 0-1.18-.568-1.12-1.227L6.34 18m11.318 0h1.091A2.25 2.25 0 0 0 21 15.75V9.456c0-1.081-.768-2.015-1.837-2.175a48.055 48.055 0 0 0-1.913-.247M6.34 18H5.25A2.25 2.25 0 0 1 3 15.75V9.456c0-1.081.768-2.015 1.837-2.175a48.041 48.041 0 0 1 1.913-.247m10.5 0a48.536 48.536 0 0 0-10.5 0m10.5 0V3.375c0-.621-.504-1.125-1.125-1.125h-8.25c-.621 0-1.125.504-1.125 1.125v3.659M18 10.5h.008v.008H18V10.5Zm-3 0h.008v.008H15V10.5Z" />
                                    </svg>
                                </PrintButton>
